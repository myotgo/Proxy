# Android Connection Guide - Layer 3 (Basic SSH)
...
**Net Mod** or any other SSH Tunnel app

---

## Connection Steps

Follow these images step by step:
...
In the app, enter this information:
...
- Make sure to use port **22** (Layer 3)
- Enter the username and password you created on the server
- If connection fails, recheck the information
